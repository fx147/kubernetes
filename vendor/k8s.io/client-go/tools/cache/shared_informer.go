...
func (s *sharedIndexInformer) Run(stopCh <-chan struct{}) {
	...
	// 创建一个单独的processorStopch通道，用来控制processor和cacheMutationDetector的停止
...
// 如果是sync，只通知注册了syncingListeners的eventHandler
